                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label d-flex justify-content-between align-items-center">
                                <span>Telefones</span>
                                <button type="button" class="btn btn-sm btn-outline-secondary" data-phone-add data-phone-target="person-phones">Adicionar telefone</button>
                            </label>
                            <div class="vstack gap-2" id="person-phones">
                            ...
                            <template id="person-phones-template">
                                <div class="border rounded p-2" data-phone-row>
                                    <div class="row g-2 align-items-end">
                                        <div class="col-12 col-md-5">
                                            <label class="form-label small">Numero</label>
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <select class="form-select" name="has_physical_disability" data-conditional-toggle="person-disability-details">
                                <option value="0" <?= ((int) ($person['has_physical_disability'] ?? 0) !== 1) ? 'selected' : '' ?>>Nao</option>
                                <option value="1" <?= ((int) ($person['has_physical_disability'] ?? 0) === 1) ? 'selected' : '' ?>>Sim</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-4 <?= ((int) ($person['has_physical_disability'] ?? 0) === 1) ? '' : 'd-none' ?>" data-conditional-group="person-disability-details">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <select class="form-select" name="uses_continuous_medication" data-conditional-toggle="person-medication-details">
                                <option value="0" <?= ((int) ($person['uses_continuous_medication'] ?? 0) !== 1) ? 'selected' : '' ?>>Nao</option>
                                <option value="1" <?= ((int) ($person['uses_continuous_medication'] ?? 0) === 1) ? 'selected' : '' ?>>Sim</option>
                            </select>
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    setupPhoneCollection('person-phones');
