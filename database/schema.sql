...
CREATE TABLE IF NOT EXISTS families (
  ...
  chronic_disease_other_details VARCHAR(200) NULL,
  ...
  has_addiction TINYINT(1) NOT NULL DEFAULT 0,
  addiction_details VARCHAR(200) NULL,
  social_benefit VARCHAR(80) NULL,
  housing_type_other_details VARCHAR(200) NULL,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS family_members (
  ...
  receives_social_benefit TINYINT(1) NOT NULL DEFAULT 0,
